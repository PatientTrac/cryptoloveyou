;(function () {
  ...
  // Tailwind CDN (widget uses utility classes)
  ...
  style.textContent =
    ...
    'cursor:pointer;box-shadow:0 8px 32px rgba(124,58,237,.5);border:none;z-index:9998;' +
    ...
    '@media(max-width:480px){#grok-widget{width:100vw!important;height:100vh!important;' +
  ...
  widget.innerHTML =
    ...
    '</div>' +
    '<div id="grok-messages" style="flex:1;overflow-y:auto;padding:20px;display:flex;' +
    'flex-direction:column;gap:12px;background:#0f172a"></div>' +
    '<div style="padding:14px 16px;border-top:1px solid rgba(255,255,255,.08);display:flex;' +
    'align-items:center;gap:10px;background:#0f172a;flex-shrink:0">' +
      '<button id="grok-mic" style="width:44px;height:44px;border-radius:14px;' +
      'background:rgba(255,255,255,.1);border:none;cursor:pointer;font-size:22px;' +
  ...
  function addBubble (html, isUser) {
    ...
    b.style.cssText = 'max-width:78%;padding:12px 16px;border-radius:18px;font-size:13px;' +
      'line-height:1.6;color:#fff;word-break:break-word;' +
